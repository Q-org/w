...
var isDeployPreview = !!process.env.NETLIFY && process.env.CONTEXT === 'deploy-preview';
...
function getNextBetaVersionName() {
  ...
  if (!lastReleasedVersion.includes(expectedPrefix)) {
    throw new Error('this code is only meant to be used during the 2.0 beta phase.');
  }
...
var isBranchDeploy = !!process.env.NETLIFY && process.env.CONTEXT === 'branch-deploy';
var config = {
  title: '微课程',
  tagline: '微课程很酷',
  ...
  i18n: {
    defaultLocale: 'zh-CN',
    locales: isDeployPreview || isBranchDeploy ? // Deploy preview and branch deploys: keep them fast!
    ['zh-CN'] : isI18nStaging ? // Staging locales: https://docusaurus-i18n-staging.netlify.app/
  ...
  /** @type {import('@docusaurus/preset-classic').Options} */
  {
    docs: {
      ...
      onlyIncludeVersions: function () {
        ...
        if (!isVersioningDisabled && (isDev || false)) {
          return ['current'].concat(_toConsumableArray(versions.slice(0, 2)));
        }
    ...
    blog: {
      ...
      readingTime: function readingTime(_ref) {
        ...
        return frontMatter.hide_reading_time ? undefined : defaultReadingTime({
          content: content
        });
      },
      editUrl: // Please change this to your repo.
      // Remove this to remove the "edit this page" links.
      'http://127.0.0.1/p/'
    },
    theme: {
  ...
  /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
  {
    ...
    footer: {
      ...
      // style: "dark",
      copyright: "\u7248\u6743 \xA9 ".concat(new Date().getFullYear(), " Q-org.")
    },
    colorMode: {
      defaultMode: "dark"
    }
  },
  plugins: ["docusaurus-plugin-less", '@docusaurus/plugin-ideal-image', '@docusaurus/theme-mermaid', require.resolve("docusaurus-plugin-image-zoom"), //...dogfoodingPluginInstances,
  ['client-redirects',
  ...
  }], "@graphql-markdown/docusaurus", 'docusaurus-plugin-sass', function myPlugin(context, options) {
          ...
          case 0:
            return _context3.abrupt("return", {
              ...
              contentLoaded: function contentLoaded(_ref2) {
                var content, actions;
                return regeneratorRuntime.async(function contentLoaded$(_context2) {
                  while (1) {
